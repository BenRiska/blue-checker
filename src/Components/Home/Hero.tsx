        ...
        <div className="hero">
            <div className="hero__container">
                ...
                <div className="button-container">
                    ...
                    <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 8l4 4-4 4" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                </div>
