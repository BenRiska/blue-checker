        ...
        <div className="blogs">
            ...
            <div className="blogs__row-2">
                <div className="blogs__blog blog-2">
                    ...
                    <div className="blog__content">
                        ...
                        <h2>
                        Our plans for BlueReceipt in 2020
                        </h2>
                        <p>
                        We’ve been busy behind the scenes working to build the future of presentations. It’s time to give you a peek at what we’ve been up to and sh...
                        </p>
                        <div className="blog__author">
                ...
                <div className="blogs__blog blog-2">
                    ...
                    <div className="blog__content">
                        ...
                        <h2>
                        Shining a spotlight on our beta users
                        </h2>
                        <p>
                        We’re ready to showcase how some of our very first users are using Bluereceipt to raise money, work faster, and communicate more effectively.
                        </p>
                        <div className="blog__author">
                ...
                <div className="blogs__blog blog-2">
                    ...
                    <div className="blog__content">
                        ...
                        <h2>
                        BlueReceipt 101: How to create Auto-Pilot
                        </h2>
                        <p>
                        Tee Tran oversees the creation of all of our presentation templates, and in this post, she gives us a look inside her design process.
                        </p>
                        <div className="blog__author">
            ...
            <div className="blogs__blog blog-3">
                    ...
                    <div className="blog__content">
                        ...
                        <h2>
                        Announcing our limited preview beta & new funding
                        </h2>
                        <p>
                        We're inviting the first teams and companies to use BlueReceipt, opening up our invite-only beta with the help of some additional funding.
                        </p>
                        <div className="blog__author">
                            <div style={{background: "#ffc480"}} className="blog__author-img">
                                <img src="https://uploads-ssl.webflow.com/5e8b8f0cd098a8db668ff85e/5ec3f709822c035c3d34db18_T9UUTS33Q-UM13GQL9Z-088264d55d40-512-removebg-preview%201.png" alt=""/>
                ...
                <div className="blogs__blog blog-3">
                    ...
                    <div className="blog__content">
                        ...
                        <h2>
                        Introducing to the BlueReceipt
                        </h2>
                        <p>
                        We’ve been busy behind the scenes working to build the future of presentations. It’s time to give you a peek at what we’ve been up to and shar...
                        </p>
                        <div className="blog__author">
                            <div style={{background: "#c4eafd"}} className="blog__author-img">
                            <img src="https://uploads-ssl.webflow.com/5e8b8f0cd098a8db668ff85e/5ec3f708822c030d7f34db16_image%205.png" alt=""/>
            ...
            <div className="blogs__blog blog-4">
                <img src="https://uploads-ssl.webflow.com/5f637e323fd92186000b17a2/5fad2f713da51b202edd103f_Mask%20Group.png"  alt=""/>
                    <div className="blog__content">
                        ...
                        <h2>
                        BlueReceipt 101: How to Create Auto-Response
                        </h2>
                        <p>
                        We're inviting the first teams and companies to use BlueReceipt, opening up our invite-only beta with the help of some additional funding.
                        </p>
                ...
                <div className="blogs__blog blog-4">
                    ...
                    <div className="blog__content">
                        ...
                        <h2>
                        BlueReceipt 101: Manage the your Campaign
                        </h2>
                        <p>
                        We're inviting the first teams and companies to use BlueReceipt, opening up our invite-only beta with the help of some additional funding.
                        </p>
